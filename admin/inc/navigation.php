...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary text-white bg-gray disabled elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        ...
        <span class="brand-text font-weight-light" style=" font-family: 'verdana', sans-serif;"><?php echo $_settings->info('short_name') ?></span>
        </a>
        <!-- Sidebar -->
                   ...
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false" >
                    <li class="nav-item dropdown" style=" font-family: 'verdana', sans-serif;">
                      <a href="./" class="nav-link nav-home">
                        <i class="nav-icon fas fa-tachometer-alt" style=" padding: 8px 8px"   ></i>
                        <p >
                          Dashboard
                        </p>
                      </a>
                    ...
                    <li class="nav-item dropdown" style=" font-family: 'verdana', sans-serif;">
                      <a href="<?php echo base_url ?>admin/?page=employees/records&id=<?php echo $_settings->userdata('id') ?>" class="nav-link nav-records">
                        <i class="nav-icon fas fa-id-card" style=" padding: 8px 8px"></i>
                        <p>
                          My Records
                        </p>
                      </a>
